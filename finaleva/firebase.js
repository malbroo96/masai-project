...
const auth = getAuth(app ,createUserWithEmailAndPassword,signInWithEmailAndPassword, signOut);      


export { app, analytics, database, auth, signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, getfirestore };
